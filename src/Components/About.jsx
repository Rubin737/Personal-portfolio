...
export const About = () => {
  return (
    <div id="about me">
      <h1 className="only-headding heading mt-20 ml-5 mr-5 ">About Me</h1>
      <section className="mt-10 p-5 flex flex-col  lg:flex-row lg:flex-wrap md:mx-13 md:items-center  lg:justify-center ">
        <div className="flex flex-col gap-12  ml-0 md:ml-5 ">
          <div className="flex flex-col gap-5 about-shadow">
            <h1 className="md:text-3xl text-2xl font-bold text-purple-400">
              Education
            </h1>
            <div className="flex items-center gap-5">
              ...
              <p>
                ...
                <span className="font-bold">
                  ...
                  <span className=" text-base text-emerald-400">BCA</span>
                </span>
              </p>
            </div>
            <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col gap-5 about-shadow">
            ...
            <div className="flex items-center gap-5">
              ...
              <p>
                ...
                <span className="font-bold">Login360</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5 w-full lg:w-[50%] md:ml-10 md:mt-10">
          <div className="about-shadow">
            <h1 className="md:text-3xl text-2xl font-bold mb-5 mt-5 text-purple-400">
              About
            </h1>
            <p className="text-base">
              Hi, I’m Rubin. I’m a web developer who loves coding and learning
              new technologies. I’m passionate about creating meaningful and
              user-friendly experiences. Every day is an opportunity to grow and
              improve, and I’m excited about the journey ahead!
            </p>
            <div className="flex gap-3 items-center mt-5">
              ...
              <a href={cv} target="_blank">
                <p className=" text-xl text-cyan-400 underline italic font-serif tracking-wide cursor-pointer">
                  Resume
                </p>
              </a>
            </div>
          ...
          <div className="flex flex-col gap-5">
            <h1 className="md:text-3xl text-2xl gradient- font-bold text-purple-400">
              Skills
            </h1>
