        ...
        <div className="flex sm:flex-row flex-col  justify-center gap-10">
          <div className="flex flex-col gap-5 md:w-[40%] w-full">
            ...
            <p className="text-xl text-yellow-400">
              Excited to connect? Let’s talk and build something amazing!
            </p>
            <div className="flex flex-row gap-5 items-center">
              <img width={30} src={phone} alt="" />
              <p>+91 6374215923</p>
            </div>
            <div className="flex flex-row gap-5 items-center">
              <img width={30} src={mail} alt="" />
              <p>rubin262002@gmail.com</p>
            </div>
            <div className="flex flex-row gap-5 items-center">
          ...
          <form
            ...
            data-netlify="true"
            onSubmit={onSubmit}
            className="flex flex-col gap-5 md:w-[50%] w-full flex-start justify-center"
          >
            ...
            <input
              ...
              className="border-contact text-black"
              required
            />
            ...
            <textarea
              ...
              className="border-2 py-3 pl-3 sm:pb-32 pb-24 text-xl text-black bg-gray-300 rounded-sm"
              required
            />
